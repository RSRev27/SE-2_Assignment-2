...
public class SelinumTest {
	 ...
	 * @Order(3)
	 * 
	 * @Test public void testLoginWithCorrectCreds() throws Exception {
	...
	//	myTestCase.createBoard(driver, element, wait, props);
	//}
	// myTestCase.createLists(driver, element, wait, props);
	// myTestCase.createCards(driver, element, wait, props); }
	...
	public void testOtherFeatures() throws Exception {
		// myTestCase.createBoard(driver, element, wait, props);
		// myTestCase.createLists(driver, element, wait, props);
		//myTestCase.performFiltersAndOtherFeatures(driver, element, wait, props);
		myTestCase.loginWithValidCreds(driver, element, wait, props);
		myTestCase.performLogOut(driver, element, wait, props);
	}
